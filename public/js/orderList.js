            ...
            case 1:
                switch (order.payment_method) {
                    ...
                    case 1:
                        ...
                        html = html + `<tr id="order_id_row_${order.id}"><td><input type="checkbox" name="check_order_del" value="${order.id}"></td><td>#${order.id}</td><td>${order.name}</td><td>${order.mobile}</td><td>${order.email}</td><td id='order_status_${order.id}'>Đã đặt hàng</td><td>${credate11}</td><td>Bank</td><td>${order.shipping_name}</td><td>${order.shipping_mobile}</td><td>${shipdate11}</td><td>${shipfee1.toLocaleString('vi-VN')} đ</td><td>${total1.toLocaleString('vi-VN')} đ</td><td>${totalwFee1.toLocaleString('vi-VN')} đ</td><td>${order.housenumber_street}</td><td >${order.staffname}</td><td > <input type="button" id="acpt_orderID_${order.id}"onclick="Accept(${order.id});" value="Xác nhận" class="btn btn-primary btn-sm"></td><td ><form action="http://localhost:3000/admin/home/dashboard/getOrder" method="GET"> <input type="hidden" value="${order.id}" name="order_edit" /><input type="submit" value="Sửa" class="btn btn-warning btn-sm"> </form></td><td > <input type="button" onclick="del_order(${order.id});" value="Xóa" class="btn btn-danger btn-sm"></td></tr>`
                        break;
            ...
            case 2:
                switch (order.payment_method) {
                    ...
                    case 1:
                        ...
                        const credate11 = getFormatDateTime(order.created_date)
                        const shipdate11 = getFormatDate(order.delivered_date)
                        html = html + `<tr id="order_id_row_${order.id}"><td><input type="checkbox" name="check_order_del" value="${order.id}"></td><td>#${order.id}</td><td>${order.name}</td><td>${order.mobile}</td><td>${order.email}</td><td  id='order_status_${order.id}'>Đã xác nhận</td><td>${credate11}</td><td>Bank</td><td>${order.shipping_name}</td><td>${order.shipping_mobile}</td><td>${shipdate11}</td><td>${shipfee1.toLocaleString('vi-VN')} đ</td><td>${total1.toLocaleString('vi-VN')} đ</td><td>${totalwFee1.toLocaleString('vi-VN')} đ</td><td>${order.housenumber_street}</td><td >${order.staffname}</td><td > </td><td ><form action="http://localhost:3000/admin/home/dashboard/getOrder" method="GET"> <input type="hidden" value="${order.id}" name="order_edit" /><input type="submit" value="Sửa" class="btn btn-warning btn-sm"> </form></td><td > <input type="button" onclick="del_order(${order.id});" value="Xóa" class="btn btn-danger btn-sm"></td></tr>`
                        break;
            ...
            case 3:
                switch (order.payment_method) {
                    ...
                    case 1:
                        ...
                        const credate11 = getFormatDateTime(order.created_date)
                        const shipdate11 = getFormatDate(order.delivered_date)
                        html = html + `<tr id="order_id_row_${order.id}"><td><input type="checkbox" name="check_order_del" value="${order.id}"></td><td>#${order.id}</td><td>${order.name}</td><td>${order.mobile}</td><td>${order.email}</td><td  id='order_status_${order.id}'>Hoàn tất đóng gói</td><td>${credate11}</td><td>Bank</td><td>${order.shipping_name}</td><td>${order.shipping_mobile}</td><td>${shipdate11}</td><td>${shipfee1.toLocaleString('vi-VN')} đ</td><td>${total1.toLocaleString('vi-VN')} đ</td><td>${totalwFee1.toLocaleString('vi-VN')} đ</td><td>${order.housenumber_street}</td><td >${order.staffname}</td><td > </td><td ><form action="http://localhost:3000/admin/home/dashboard/getOrder" method="GET"> <input type="hidden" value="${order.id}" name="order_edit" /><input type="submit" value="Sửa" class="btn btn-warning btn-sm"> </form></td><td > <input type="button" onclick="del_order(${order.id});" value="Xóa" class="btn btn-danger btn-sm"></td></tr>`
                        break;
            ...
            case 4:
                switch (order.payment_method) {
                    ...
                    case 1:
                        ...
                        const credate11 = getFormatDateTime(order.created_date)
                        const shipdate11 = getFormatDate(order.delivered_date)
                        html = html + `<tr id="order_id_row_${order.id}"><td><input type="checkbox" name="check_order_del" value="${order.id}"></td><td>#${order.id}</td><td>${order.name}</td><td>${order.mobile}</td><td>${order.email}</td><td  id='order_status_${order.id}'>Đang giao hàng</td><td>${credate11}</td><td>Bank</td><td>${order.shipping_name}</td><td>${order.shipping_mobile}</td><td>${shipdate11}</td><td>${shipfee1.toLocaleString('vi-VN')} đ</td><td>${total1.toLocaleString('vi-VN')} đ</td><td>${totalwFee1.toLocaleString('vi-VN')} đ</td><td>${order.housenumber_street}</td><td >${order.staffname}</td><td > </td><td ><form action="http://localhost:3000/admin/home/dashboard/getOrder" method="GET"> <input type="hidden" value="${order.id}" name="order_edit" /><input type="submit" value="Sửa" class="btn btn-warning btn-sm"> </form></td><td > <input type="button" onclick="del_order(${order.id});" value="Xóa" class="btn btn-danger btn-sm"></td></tr>`
                        break;
            ...
            case 5:
                switch (order.payment_method) {
                    ...
                    case 1:
                        ...
                        const credate11 = getFormatDateTime(order.created_date)
                        const shipdate11 = getFormatDate(order.delivered_date)
                        html = html + `<tr id="row_ID_${order.id}"><td><input type="checkbox" name="check_order_del" value="${order.id}"></td><td>#${order.id}</td><td>${order.name}</td><td>${order.mobile}</td><td>${order.email}</td><td  id='order_status_${order.id}'>Đã giao thành công</td><td>${credate11}</td><td>Bank</td><td>${order.shipping_name}</td><td>${order.shipping_mobile}</td><td>${shipdate11}</td><td>${shipfee1.toLocaleString('vi-VN')} đ</td><td>${total1.toLocaleString('vi-VN')} đ</td><td>${totalwFee1.toLocaleString('vi-VN')} đ</td><td>${order.housenumber_street}</td><td >${order.staffname}</td><td > </td><td ><form action="http://localhost:3000/admin/home/dashboard/getOrder" method="GET"> <input type="hidden" value="${order.id}" name="order_edit" /><input type="submit" value="Sửa" class="btn btn-warning btn-sm"> </form></td><td > <input type="button" onclick="del_order(${order.id});" value="Xóa" class="btn btn-danger btn-sm"></td></tr>`
                        break;
